    ...
    <PBXShell>
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-white">Billing & Usage</h1>
            <p className="text-sm text-slate-400 mt-0.5">Provider costs and usage for your tenant</p>
          </div>
        ...
        {loading ? (
          ...
          <PBXEmptyState icon={<CreditCard className="w-7 h-7 text-slate-500" />} title="No usage records yet" description="Cost and usage records appear once your provider connection is live and syncing data." />
        ) : (
        ...
        <div className="bg-[#1E293B]/50 rounded-xl border border-[rgba(255,255,255,0.04)] p-4">
          <p className="text-xs text-slate-500">Costs reflect confirmed provider charges where available. Estimates are marked as unconfirmed.</p>
        </div>
      </div>
    </PBXShell>
  );
