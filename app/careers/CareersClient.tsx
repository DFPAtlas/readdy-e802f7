        ...
        <section className="py-16 bg-slate-50">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold text-slate-900 mb-3">Life at Digital Footprint</h2>
              <p className="text-slate-500 max-w-2xl mx-auto">
                We are a small, cross-functional team building digital products for independent UK businesses. We value autonomy, honest feedback, and shipping work that genuinely helps the people who use it.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white border border-slate-200 rounded-2xl p-5">
                <div className="w-10 h-10 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                  <i className="ri-lightbulb-line w-5 h-5 text-[#06B6D4] flex items-center justify-center" />
                </div>
                <h3 className="font-bold text-slate-900 mb-1.5">Own Your Work</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  You will be trusted to make decisions, take responsibility for outcomes, and see the direct impact of your work on the products and the businesses they serve.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-2xl p-5">
                <div className="w-10 h-10 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                  <i className="ri-chat-3-line w-5 h-5 text-[#06B6D4] flex items-center justify-center" />
                </div>
                <h3 className="font-bold text-slate-900 mb-1.5">Honest & Open</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  We share context openly, give candid feedback, and expect the same in return. No politics, no unnecessary meetings, just clear communication about what matters.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-2xl p-5">
                <div className="w-10 h-10 rounded-xl bg-[#06B6D4]/10 flex items-center justify-center mb-4">
                  <i className="ri-rocket-line w-5 h-5 text-[#06B6D4] flex items-center justify-center" />
                </div>
                <h3 className="font-bold text-slate-900 mb-1.5">Always Learning</h3>
                <p className="text-sm text-slate-500 leading-relaxed">
                  Technology moves quickly, and so do we. We invest in continuous learning, encourage experimentation, and celebrate well-considered improvements to how we build.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
              {[
                { icon: 'ri-time-line', label: 'Flexible working' },
                { icon: 'ri-computer-line', label: 'Hybrid & remote' },
                { icon: 'ri-heart-3-line', label: 'Supportive team' },
                { icon: 'ri-medal-line', label: 'Real responsibility' },
              ].map((b) => (
                <span key={b.label} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 text-sm text-slate-600">
                  <i className={`${b.icon} w-4 h-4 text-[#06B6D4] flex items-center justify-center`} />
                  {b.label}
                </span>
              ))}
            </div>
