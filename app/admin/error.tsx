...
export default function AdminErrorPage({
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex flex-col items-center justify-center px-4">
      ...
      <h1 className="text-xl font-bold text-white mb-2">Admin Page Error</h1>
      <p className="text-sm text-slate-400 mb-8 max-w-md text-center">
        An unexpected error occurred while loading this page. This is not an authentication issue &mdash; your session is still active.
      </p>
