...
const related = [
  { title: 'Websites & SaaS', icon: 'ri-code-s-slash-line', color: '#06B6D4', desc: 'Professional websites, business applications and SaaS platforms.', href: '/services/websites-saas' },
  { title: 'Business Portals', icon: 'ri-dashboard-line', color: '#F97316', desc: 'Secure client and staff portals for documents, messaging and tracking.', href: '/services/business-portals' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {related.map((service, i) => (
            ...
            >
              <Link
                href={service.href}
                className="group block glass-card rounded-2xl p-6 h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:ring-offset-2 focus:ring-offset-white"
              >
                <div
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-[#7C3AED] transition-colors">{service.title}</h3>
