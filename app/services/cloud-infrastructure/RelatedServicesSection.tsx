...
const related = [
  ...
  { title: 'Business Portals', icon: 'ri-dashboard-line', color: '#10B981', desc: 'Secure customer, staff and management portals in one place.', href: '/services/business-portals' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {related.map((service, i) => (
            ...
            >
              <Link
                href={service.href}
                className="group block glass-card rounded-2xl p-6 h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#3B82F6] focus:ring-offset-2 focus:ring-offset-white"
              >
                <div
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-[#3B82F6] transition-colors">{service.title}</h3>
