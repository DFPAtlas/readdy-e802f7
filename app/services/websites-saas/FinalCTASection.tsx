...
export default function FinalCTASection() {
  return (
    <section className="py-24 px-6 bg-[#060F1E] relative overflow-hidden">
      <div className="absolute inset-0" style={{ background: 'radial-gradient(circle at 50% 50%, rgba(6,182,212,0.07) 0%, transparent 60%)' }} />
      <div className="absolute inset-0 opacity-[0.01]" style={{ backgroundImage: 'radial-gradient(circle, rgba(6,182,212,0.5) 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight mb-6">
            Have an idea for a website or platform?
          </h2>
          <p className="text-lg md:text-xl text-slate-400 mb-10 leading-relaxed">
            Tell us what you are trying to achieve and we will help you work out the right digital
            approach.
          </p>
