...
const related = [
  { title: 'AI & Automation', icon: 'ri-robot-line', color: '#7C3AED', desc: 'Add AI agents and automated workflows to your website or platform.', href: '/services/ai-automation' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {related.map((service, i) => (
            ...
            >
              <Link
                href={service.href}
                className="group block glass-card rounded-2xl p-6 h-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#06B6D4] focus:ring-offset-2 focus:ring-offset-white"
              >
                <div
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-[#06B6D4] transition-colors">{service.title}</h3>
